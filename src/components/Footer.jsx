...
export default function Footer(){
    return (
        <footer className="border-t border-white/7 px-4 sm:px-6 pt-12 md:pt-14 pb-8">
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-10 md:mb-12">
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-sm text-white/35 leading-relaxed font-light max-w-xs font-poppins">
                            A 5-week summer hackathon for students aged 14-18 from across the Arab world.Build , Film & Compete.
                        </p>
                        <p className="mt-4 text-accent/60 text-xs italic font-poppins">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2.5">
                            {navLinks.map((l)=>(
                                <a key={l.label} href={l.href} className="text-sm text-white/50 hover:text-accent font-poppins transition-colors duration-200 w-fit lowercase">
                                    {l.label}
                                </a>
                            ))}
                        </div>
